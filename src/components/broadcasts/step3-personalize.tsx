    ...
    <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  <div>
                    ...
                    >
                      ...
                      <SelectContent className="border-border bg-popover">
                        <SelectItem value="static">{t('step3.staticValue')}</SelectItem>
                        <SelectItem value="field">{t('step3.contactField')}</SelectItem>
                  ...
                  <div>
                    ...
                    {mapping.type === 'static' ? (
                      ...
                      >
                        <SelectTrigger className="w-full border-border bg-muted text-foreground">
                          <SelectValue placeholder={t('step3.selectFieldPlaceholder')} />
                        </SelectTrigger>
                        <SelectContent className="border-border bg-popover">
                            ...
                            placeholder={
                              loadingFields
                                ...
                                : customFields.length === 0
                                  ? t('step3.noCustomFieldsPlaceholder')
                                  : t('step3.selectCustomFieldPlaceholder')
                            }
                          />
                        </SelectTrigger>
                        <SelectContent className="border-border bg-popover">
      ...
      <div className="rounded-xl border border-border bg-card/50 p-4">
        <div className="mb-3 flex items-center gap-2">
          ...
          <p className="text-sm font-medium text-foreground">{t('step3.livePreview')}</p>
      ...
      {unmappedKeys.length > 0 && (
        <div className="rounded-md border border-amber-500/30 bg-amber-500/10 px-3 py-2 text-xs text-amber-300">
          {t('step3.unmappedWarningPrefix')}{' '}
          <span className="font-mono font-semibold">
            {unmappedKeys.join(', ')}
          </span>
          {t('step3.unmappedWarningSuffix')}
        </div>
      )}
